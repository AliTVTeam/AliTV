...
** Input
Input for the simple mode should be in fasta format (gb and gff will be possible soon).
Annotation files can be supplied in tsv format (have to be specified in the yaml file).
