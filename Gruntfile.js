module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		jasmine: {
			components: {
				...
				options: {
					...
					specs: ['d3/test/spec/testing_loadKaryo.js',
						...
						'd3/test/spec/testing_drawingStuff.js'
					],
					vendor: ['d3/lib/jquery.min.js', 'd3/lib/d3.v3.min.js',
		...
		concat: {
			options: {},
			dist: {
				src: ['d3/src/getRibbon.js', 'd3/src/karyoToCoords.js',
					'd3/src/LinksToCoords', 'd3/src/loadKaryo.js',
					'd3/src/loadLinks.js', 'd3/src/svgElements.js',
					'd3/src/drawingStuff.js', 'd3/src/drawLinks.js'
				],
	...
	// Default task(s).
	grunt.registerTask('default', ['jsbeautifier:verify', 'jshint', 'jasmine']);
