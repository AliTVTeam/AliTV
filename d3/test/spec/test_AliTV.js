...
describe('The getLinearFeatureCoords method is supposed to calculate coordinates for feature classes in the linear layout', function(){
	...
	it('getLinearFeatureCoords method is supposed to return the expected coordinates for strand specific features on three chromosomes, the should be drawn on the negative strand', function(){
		...
		ali.conf.features.showAllFeatures = true;
		console.log(ali);
		var expectedFeatures = [{"id": "f1", "type": "gene", "karyo": "c1", "height": 4/5 * defaultConf.features.supportedFeatures.gene.height, "x": 100 * 1000 / 2000, "width": Math.abs(200 - 100) * 1000 / 2000, "y": 0},
		                        {"id": "f2", "type": "gene", "karyo": "c2", "height": 4/5 * defaultConf.features.supportedFeatures.gene.height, "x": 300 * 500 / 1000, "width": Math.abs(300 - 400) * 500 / 1000, "y": 485},
		                        {"id": "f3", "type": "gene", "karyo": "c3", "height": 4/5 * defaultConf.features.supportedFeatures.gene.height, "x": 500 * 500 / 1000, "width": Math.abs(600 - 500) * 500 / 1000, "y": 970}];
		var linearKaryoCoords = ali.getLinearKaryoCoords();
		var linearFeatureCoords = ali.getLinearFeatureCoords(linearKaryoCoords);
		expect(linearFeatureCoords).toEqual(expectedFeatures);
	});
