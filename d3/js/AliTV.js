...
function AliTV(svg) {
	 ...
	 * @property {Boolean} filters.skipChromosomesWithoutLinkageInformation - If a chromosome has no linkage information, the user have the possibility to skip these chromosomes or not.
